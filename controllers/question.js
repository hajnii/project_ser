...
exports.latestQuestion = async (req, res, next) => {
  ...
  let query = `select q.*,u.nickname,ifnull((select count(question_id) as board_id_cnt from p_boardview where board_id = q.question_id group by board_id),0) as view_cnt

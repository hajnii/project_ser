...
exports.getBoardlist = async (req, res, next) => {
  ...
  let query = `select b.*,u.nickname,ifnull((select count(board_id) as board_id_cnt from p_boardviewer where board_id = b.board_id group by board_id),0) as view_cnt

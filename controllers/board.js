...
exports.getBoardlist = async (req, res, next) => {
  ...
  let query = `select b.board_id, b.category, b.title, u.nickname, b.created_at,b.endtime from p_board as b left join p_user as u on b.user_id = u.id order by created_at desc limit ${offset}, ${limit}`;
  console.log(query);
